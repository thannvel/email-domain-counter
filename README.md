...
- stores the results in a SQLite database for efficient querying
- displays the top 10 most frequent domains based on the stored data

This workflow offers a simple and effective way to count emails in any dataset.
